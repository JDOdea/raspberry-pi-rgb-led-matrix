// Control 16x32 RGB matrixes via GPIO. It allows daisy chaining
// of these in a string, while also connacting a parallel string on newer
...
namespace rgb_matrix
{
    ...
    //
    // This implements the Canvas interface that represents the display with
    // (led_cols * chaned_displays)x(rows * parallel_displays) pixels.
    //
    // Can do multi-buffering using the CreateFrameCanvas() and SwapOnVSync()
    ...
    {
    public:
        // Options to intialize the RGBMatrix. Also see the main README.md for
        // detailed descriptions of the command line flags.
        // TODO: Add descriptions to main README.md
        struct Options
        {
            ...
            // GPIO pins, that is 1, in newer Pis with 40 interface pins, that can
            // also be 2 or 3. The effective number of pixels in vertical direction is
            // then rows * parallel. Default: 1
            // Flag: --led-parallel
            int parallel;

            // Set PWM bits used for output. Default is 11, but if you only deal with
            // limited comic-colors, 1 might be sufficient. Lower requires less CPU and
        ...
        static RGBMatrix *CreateFromOptions(const Options &options, const RuntimeOptions &runtime_options);

        // A factory that parses your main() commandline flags to read options
        // meant to configure the matrix and returns a freshly allocated matrix.
        //
        ...
        // buffer implements a Canvas with the same size of the RGBMatrix.
        ...
        // VSync of to retrieve the initial buffer when preparing a multi-buffer
        // animation.
        //
        ...
        // (Say you have 140Hz refresh rate, then a value of 5 would give you a
        ...
        // Returns a boolean indicationg if this was successful.
        bool ApplyPixelMapper(const PixelMapper *mapper);

        // Set PWM bits used for output. Default is 11, but if you only deal with
        // limited comic-colors, 1 might be sufficient. Lowers require less CPU and
        // increases refresh-rate.
        //
        ...
        // AwaitInputChange().
        // Only bits that are not already in use for reading or writing
        ...
        // Only bits that are not already in use for reading or writing
        // by the matrix are allowed.
        // Returns the subset bits that are ACTUALLY available.
    ...
    public:
        ...
        //
        // Returns a "data" pointer and the data "len" in the given out-parameters;
    ...
    // and detailed description in ____
    // TODO: Add detailed description to README
    //
    // Example use:
    /*
    ...
    */
    ...
    // Show all the availble options in a style that can be used in a --help
